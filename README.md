...
### [polymarket-sports-markets](polymarket-sports-markets) — thirteen studies on sports
...
out, both teams to score, the first set in tennis, point spreads, home advantage and NRFI) are listed with their files in the directory's
README.
