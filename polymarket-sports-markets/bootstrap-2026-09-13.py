#!/usr/bin/env python3
"""Market-level bootstrap for the 2026-09-13 sports studies.

Every row of the input is one market, so resampling rows is resampling markets.
    python3 bootstrap-2026-09-13.py <csv> [<csv> ...]
